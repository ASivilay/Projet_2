...
with open('data.csv', 'w') as csv_file:
	...
	while True:
		...
		lis = pageSoup.find('ol', class_='row').find_all('li')
		for li in lis:
			...
			writer.writerow([productTitle, productUrl, productCategory, productExcTax, productIncTax, productAvailability, productUniversalCode, productReview])
